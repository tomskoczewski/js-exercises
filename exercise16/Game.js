class Game {
    ...
    startGame() {
        if (this.inputBid.value < 1) {
            return alert("The entered amount is too small");
        }
        const bid = Math.floor(this.inputBid.value);
        if (!this.wallet.checkCanPlay(bid)) {
            return alert('You dont have enough money or the values is incorrect');
        }
        ...
        this.render(colors, this.wallet.getWalletValue(), win, this.stats.showGameStatistics(), wonMoney, bid)
    }
